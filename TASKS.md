...
### Task 10I — Bullet-aware editing · Stage 2: push the page down when a list runs out of room  🔲 EXPERIMENT (branch)
...
### Task 10I(A) — Fix: a bullet list shows two edit boxes (double edit-target) — sub-task of 10I  🔲 (branch `bullet-stage-2`)
...
### Task 10I(B) — Fix: pushed bullet text changes font/size — sub-task of 10I  🔲 (branch `bullet-stage-2`)
...
### Task 10I(C) — Fix: pushed bullets show two dots (the cover paints the dot) — sub-task of 10I  🔲 (branch `bullet-stage-2`)
